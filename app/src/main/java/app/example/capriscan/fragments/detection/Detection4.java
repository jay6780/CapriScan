...
public class Detection4 extends Fragment {
    ...
    private final Map<String, String> firstAidInfo = new HashMap<String, String>() {{
        put("Foot Rot", "Isolate the infected goat and treat with foot baths, antibiotics, and foot trimming.");
        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://suddenly-clean-firefly.ngrok-free.app/predict/footrot")  // Use 10.0.2.2 for Android emulator
                        .post(requestBody)
                        .build();
