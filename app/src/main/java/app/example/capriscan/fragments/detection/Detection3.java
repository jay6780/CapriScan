...
public class Detection3 extends Fragment {
    ...
    private final Map<String, String> firstAidInfo = new HashMap<String, String>() {{
        put("Caprine Arthritis Encephalitis", "Provide supportive care, anti-inflammatory drugs, and isolate infected goats.");
        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://suddenly-clean-firefly.ngrok-free.app/predict/caprine_arthritis")  // Use 10.0.2.2 for Android emulator
                        .post(requestBody)
                        .build();
