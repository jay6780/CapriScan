...
public class Detection5 extends Fragment {
    ...
    private final Map<String, String> firstAidInfo = new HashMap<String, String>() {{
        put("Diarrhea", "Administer oral rehydration solution, keep the goat hydrated, and consult a vet if symptoms persist.");
        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://suddenly-clean-firefly.ngrok-free.app/predict/diarrhea")  // Use 10.0.2.2 for Android emulator
                        .post(requestBody)
                        .build();
