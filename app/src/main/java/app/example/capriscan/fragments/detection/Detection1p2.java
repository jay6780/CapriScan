...
import java.net.URL;
public class Detection1p2 extends Fragment {
    ...
    private final Map<String, String> firstAidInfo = new HashMap<String, String>() {{
        put("Nasal Discharge", "Clean the nostrils, provide fresh air, and monitor for other symptoms.");
        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://suddenly-clean-firefly.ngrok-free.app/predict/nasal_discharge")  // Use 10.0.2.2 for Android emulator
                        .post(requestBody)
                        .build();
