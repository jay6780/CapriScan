...
public class Detection2 extends Fragment {
    ...
    private final Map<String, String> firstAidInfo = new HashMap<String, String>() {{
        put("Ringworm", "Apply antifungal cream and isolate affected animals.");
        ...
        new Thread(() -> {
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://suddenly-clean-firefly.ngrok-free.app/predict/ringworm")  // Use 10.0.2.2 for Android emulator
                        .post(requestBody)
                        .build();
